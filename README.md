...
Tests depend on a Redis 2.8+ instance running at `localhost:6379`. If you've got that, then `python setup.py test` should work. However, `setuptools` is a piece of garbage, so you may need to `pip install` the requirements manually. YMMV.
